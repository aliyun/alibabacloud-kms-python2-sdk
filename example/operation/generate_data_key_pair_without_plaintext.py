...
class GenerateDataKeyPairWithoutPlaintext(object):
    def __init__(self):
        pass
    ...
    @staticmethod
    def generate_data_key_pair_without_plaintext(client, key_format, aad, key_id, key_pair_spec, algorithm):
    ...
    @staticmethod
    def main(args):
        kms_instance_config = GenerateDataKeyPairWithoutPlaintext.create_kms_instance_config(os.getenv('your client key file path env'), os.getenv('your client key password env'), 'your kms instance endpoint', 'your ca file path')
