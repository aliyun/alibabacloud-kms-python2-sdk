...
class Decrypt(object):
    ...
    @staticmethod
    def decrypt(client, padding_mode, aad, ciphertext_blob, key_id, iv, algorithm):
    ...
    @staticmethod
    def main(args):
        kms_instance_config = Decrypt.create_kms_instance_config(os.getenv('your client key file path env'), os.getenv('your client key password env'), 'your kms instance endpoint', 'your ca file path')
