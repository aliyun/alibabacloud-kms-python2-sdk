...
class GetPublicKeyBySharedEndpoint(object):
    def __init__(self):
        pass
    ...
    @staticmethod
    def get_public_key_by_shared_endpoint(client, key_version_id, key_id):
    ...
    def main(args):
        ...
        open_api_config = GetPublicKeyBySharedEndpoint.create_open_api_config(os.getenv('ALIBABA_CLOUD_ACCESS_KEY_ID'), os.getenv('ALIBABA_CLOUD_ACCESS_KEY_SECRET'), 'your region id')
