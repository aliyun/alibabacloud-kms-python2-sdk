...
class GetSecretValueBySharedEndpoint(object):
    def __init__(self):
        pass
    ...
    @staticmethod
    def get_secret_value_by_shared_endpoint(client, fetch_extended_config, secret_name, version_id, version_stage):
    ...
    def main(args):
        ...
        open_api_config = GetSecretValueBySharedEndpoint.create_open_api_config(os.getenv('ALIBABA_CLOUD_ACCESS_KEY_ID'), os.getenv('ALIBABA_CLOUD_ACCESS_KEY_SECRET'), 'your region id')
