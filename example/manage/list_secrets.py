...
class ListSecrets(object):
    ...
    @staticmethod
    def list_secrets(client, page_number, page_size, filters, fetch_tags):
    ...
    def main(args):
        ...
        open_api_config = ListSecrets.create_open_api_config(os.getenv('ALIBABA_CLOUD_ACCESS_KEY_ID'), os.getenv('ALIBABA_CLOUD_ACCESS_KEY_SECRET'), 'your region id')
