...
class ListAliases(object):
    ...
    @staticmethod
    def list_aliases(client, page_number, page_size):
    ...
    def main(args):
        ...
        open_api_config = ListAliases.create_open_api_config(os.getenv('ALIBABA_CLOUD_ACCESS_KEY_ID'), os.getenv('ALIBABA_CLOUD_ACCESS_KEY_SECRET'), 'your region id')
