...
class UntagResource(object):
    ...
    @staticmethod
    def untag_resource(client, secret_name, tag_keys, certificate_id, key_id):
    ...
    def main(args):
        ...
        open_api_config = UntagResource.create_open_api_config(os.getenv('ALIBABA_CLOUD_ACCESS_KEY_ID'), os.getenv('ALIBABA_CLOUD_ACCESS_KEY_SECRET'), 'your region id')
