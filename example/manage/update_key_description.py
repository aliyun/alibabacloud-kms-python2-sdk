...
class UpdateKeyDescription(object):
    def __init__(self):
        pass
    ...
    @staticmethod
    def update_key_description(client, description, key_id):
    ...
    def main(args):
        ...
        open_api_config = UpdateKeyDescription.create_open_api_config(os.getenv('ALIBABA_CLOUD_ACCESS_KEY_ID'), os.getenv('ALIBABA_CLOUD_ACCESS_KEY_SECRET'), 'your region id')
