...
class RotateSecret(object):
    ...
    @staticmethod
    def rotate_secret(client, secret_name, version_id):
    ...
    def main(args):
        ...
        open_api_config = RotateSecret.create_open_api_config(os.getenv('ALIBABA_CLOUD_ACCESS_KEY_ID'), os.getenv('ALIBABA_CLOUD_ACCESS_KEY_SECRET'), 'your region id')
