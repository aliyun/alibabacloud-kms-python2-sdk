...
class UpdateSecretRotationPolicy(object):
    def __init__(self):
        pass
    ...
    @staticmethod
    def update_secret_rotation_policy(client, enable_automatic_rotation, rotation_interval, secret_name):
    ...
    def main(args):
        ...
        open_api_config = UpdateSecretRotationPolicy.create_open_api_config(os.getenv('ALIBABA_CLOUD_ACCESS_KEY_ID'), os.getenv('ALIBABA_CLOUD_ACCESS_KEY_SECRET'), 'your region id')
