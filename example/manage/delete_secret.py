...
class DeleteSecret(object):
    ...
    @staticmethod
    def delete_secret(client, secret_name, force_delete_without_recovery, recovery_window_in_days):
    ...
    def main(args):
        ...
        open_api_config = DeleteSecret.create_open_api_config(os.getenv('ALIBABA_CLOUD_ACCESS_KEY_ID'), os.getenv('ALIBABA_CLOUD_ACCESS_KEY_SECRET'), 'your region id')
