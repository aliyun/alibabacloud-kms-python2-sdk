...
class SetDeletionProtection(object):
    def __init__(self):
        pass
    ...
    @staticmethod
    def set_deletion_protection(client, protected_resource_arn, enable_deletion_protection, deletion_protection_description):
    ...
    def main(args):
        ...
        open_api_config = SetDeletionProtection.create_open_api_config(os.getenv('ALIBABA_CLOUD_ACCESS_KEY_ID'), os.getenv('ALIBABA_CLOUD_ACCESS_KEY_SECRET'), 'your region id')
