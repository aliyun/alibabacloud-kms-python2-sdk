...
class ListSecretVersionIds(object):
    def __init__(self):
        pass
    ...
    @staticmethod
    def list_secret_version_ids(client, include_deprecated, secret_name, page_number, page_size):
    ...
    def main(args):
        ...
        open_api_config = ListSecretVersionIds.create_open_api_config(os.getenv('ALIBABA_CLOUD_ACCESS_KEY_ID'), os.getenv('ALIBABA_CLOUD_ACCESS_KEY_SECRET'), 'your region id')
